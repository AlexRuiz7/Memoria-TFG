...
\include{estilos/paquetes}
\include{estilos/paquetes_config}
...
% Agradecimientos
\include{prefacios/Agradecimientos}

% Lista de FIGURAS
\include{prefacios/ListaFiguras}

% Lista de Videos
\include{prefacios/ListaVideos}

% Lista de TABLAS
\include{prefacios/ListaTablas}
...
\include{capitulos/02_EspecificacionRequisitos}
% Capítulos 3, 4 y 5: Ingenieria Inversa
\include{capitulos/03_IngenieriaInversa_I}
\include{capitulos/04_IngenieriaInversa_II}
\include{capitulos/05_IngenieriaInversa_III}
% Capítulo 6: Análisis del sistema
\include{capitulos/06_Analisis}
% Capítulo 7: Diseño del sistema
\include{capitulos/07_Diseno}
% Capítulo 8: Implementación
\include{capitulos/08_Implementacion}
% Capitulo 9: Validación y test
\include{capitulos/09_Pruebas}
% Capítulo 10: Conclusiones y trabajo futuro
\include{capitulos/10_Conclusiones}
...
%-- ANEXOS OBLIGATORIOS --%
% Presupuesto
\include{anexos/Presupuesto}
% Indice alfabético
\include{anexos/IndiceAlfabetico}
% Bibliografia.
\include{prefacios/Bibliografia}

\include{anexos/terminologia}

%-- ANEXOS DE PROGRAMAS --%
\include{anexos/programas}

%-- ANEXOS DE FICHEROS --%
\include{anexos/ficheros}
...
%\include{anexos/Normativa}

% Hoja de cálculo del LM7
\include{anexos/LM7-fileSystem}
% Hoja de cálculo del LM7: defines
\include{anexos/LM7-defines}
